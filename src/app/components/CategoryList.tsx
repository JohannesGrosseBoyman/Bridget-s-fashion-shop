        ...
        <div className='flex gap-4 md:gap:8'>
            <Link href="/list?cat=test" className='flex-shrink-0 w-full sm:w-1/2 lg:w-1/4 xl:w-1/6'>
                <div className='relative bg-slate-100 w-full h-96 '>
                    <Image src="/slippers_silver.jpg"  alt='' fill sizes="20vw" className='object-cover' />
                </div>
                <h1 className='mt-8 font-light text-cl tracking-wide'>Slippers</h1>
            </Link>
            <Link href="/list?cat=test" className='flex-shrink-0 w-full sm:w-1/2 lg:w-1/4 xl:w-1/6'>
                <div className='relative bg-slate-100 w-full h-96 '>
                    <Image src="/bag_black.jpg" alt='' fill sizes="20vw" className='object-cover' />
                </div>
                <h1 className='mt-8 font-light text-cl tracking-wide'>Bags</h1>
            </Link>
            <Link href="/list?cat=test" className='flex-shrink-0 w-full sm:w-1/2 lg:w-1/4 xl:w-1/6'>
                <div className='relative bg-slate-100 w-full h-96 '>
                    <Image src="/watch_gold.jpg" alt='' fill sizes="20vw" className='object-cover' />
                </div>
